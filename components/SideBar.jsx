...
const defaultStyles = {
  ...
  sidebar: {
    ...
    top: 0,
    bottom: 0,
    transition: 'transform .5s cubic-bezier(0.25, 0.1, 0, 1.04)',
    WebkitTransition: '-webkit-transform .5s cubic-bezier(0.25, 0.1, 0, 1.04)',
  ...
  content: {
    ...
    transition:
      'left .5s cubic-bezier(0.25, 0.1, 0, 1.04), right .5s cubic-bezier(0.25, 0.1, 0, 1.04)'
  },
  overlay: {
    zIndex: 1,
    position: 'fixed',
    ...
    visibility: 'hidden',
    transition:
      'opacity .5s cubic-bezier(0.25, 0.1, 0, 1.04), visibility .5s cubic-bezier(0.25, 0.1, 0, 1.04)',
